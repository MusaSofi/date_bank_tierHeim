...
$array = $database->getDoctorByTierID($tierID);
...
<body style="background-color: #f3e0ff;">
    ...
    <h1> Arzt ist gefunden </h1>
    <h2><?php  echo "Name: " . $array[0];?></h2>
    <h2><?php  echo "Handynummer: " . $array[1];?></h2>

    <a href="getDoctorByTierID.php"> Go back to Finden deinen Arzt </a>
