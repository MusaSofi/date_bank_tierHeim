...
<body style="background-color: #f3e0ff;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="cat.php">Katzen</a>
                    </li>
                    <li class="nav-item">
        ...
        <table class="table table-striped">
            ...
            foreach ($katzen as $katze): ?>
                <tr>
                    ...
                    <td>
                        <?php echo $katze['TIERID']; ?>
                    </td>
                    <td>
                        <?php echo $katze['NAME']; ?>
                    </td>
                    <td>
                        <?php echo $katze['IMPFUNG']; ?>
                    </td>
                    <td>
                        <?php echo $katze['PERSONALID']; ?>
                    </td>
                    <td>
                        <?php echo $katze['ABHOLDATUM']; ?>
                    </td>
                    <td>
                        <?php echo $katze['TIER_ALTER']; ?>
                    </td>
                    <td>
                        <?php echo $katze['KATZENINDEX']; ?>
                    </td>
                    <td>
                        <?php echo $katze['HAUSKATZE']; ?>
                    </td>
                    <td>
                        <?php echo '<img src="data:image/jpeg;base64,'.base64_encode($katze['BILD']).'"/>'; ?>
                    </td>
                </tr>
                <?php
                $index++;
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="post" action="addCat.php" enctype="multipart/form-data">
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <input type="number" class="form-control" id="katzenindex" name="katzenindex"
                            placeholder="Katzenindex">
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="hauskatze" name="hauskatze" placeholder="Hauskatze">
                    </div>
                    <div class="col-auto">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="get" action="deleteKatze.php">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="get" action="updateCat.php">
                    <div class="col-auto">
                        <input type="number" class="form-control" id="tierID" name="tierID" placeholder="TierID">
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <input type="number" class="form-control" id="personalID" name="personalID" placeholder="PersonalID">
                    </div>
                    <div class="col-auto">
                        <input type="text" class="form-control" id="abholdatum" name="abholdatum" placeholder="Abholdatum">
                    </div>
                    <div class="col-auto">
                        <input type="number" class="form-control" id="tieralter" name="tieralter" placeholder="Tieralter">
                    </div>
