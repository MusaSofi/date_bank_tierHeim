...
<body style="background-color: #f3e0ff;">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="heims.php">Heime</a>
                    </li>
                    <li class="nav-item">
        ...
        <table class="table table-striped">
            ...
            foreach ($heims as $heim): ?>
                <tr>
                    ...
                    <td>
                        <?php echo $heim['HEIMID']; ?>
                    </td>
                    <td>
                        <?php echo $heim['ADRESSE']; ?>
                    </td>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="get" action="addHeims.php">
                    <div class="col-auto">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="get" action="deleteHeim.php">
                    
                    <div class="col-auto">
                        <input type="number" class="form-control" id="heimID" name="heimID" placeholder="heimID">
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form class="row g-3" method="get" action="updateheim.php">
                <div class="col-auto">
                        <input type="number" class="form-control" id="heimID" name="heimID" placeholder="heimID">
                    </div>
                    <div class="col-auto">
